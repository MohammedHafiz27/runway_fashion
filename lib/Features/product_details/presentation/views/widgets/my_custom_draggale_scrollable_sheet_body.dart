      ...
      child: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              children: [
                Text(productModel.price, style: AppStyles.styleBold20(context).copyWith(color: Colors.black87)),
                const Spacer(),
                const Icon(Icons.favorite_border, color: Colors.redAccent),
                const SizedBox(width: 6),
                Text("450", style: AppStyles.styleSemiBold16(context).copyWith(color: Colors.black54)),
              ],
            ),
